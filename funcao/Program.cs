...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("Circulo: " + CalcularAreaQuadrado(3));
    ...
    // Função simples que exige uma mensagem no console 
    static void ImprimirMensagem() => Console.WriteLine("Olá, mundo!");

    // Função que calcule a área de um quadrado
    static double CalcularAreaQuadrado(double lado) => lado * lado;

    // Função que calcule a área de um circulo
